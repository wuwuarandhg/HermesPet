...
<sub>🆕 **Windows 尝鲜版现已发布** —— 屏幕顶端的桌面 AI 伴侣，也来到了 Windows</sub>
...
[![Windows](https://img.shields.io/badge/Windows-10/11_尝鲜版-0078D4?logo=windows&logoColor=white)](https://github.com/basionwang-bot/HermesPet/releases/tag/win-v0.1.0)
...
### 🍎 [macOS 下载（DMG）→](https://github.com/basionwang-bot/HermesPet/releases/latest) · 🪟 [Windows 尝鲜版下载（exe）→](https://github.com/basionwang-bot/HermesPet/releases/tag/win-v0.1.0)

### 🌐 [访问项目主页 · hermespet.cc →](https://hermespet.cc)

macOS：直接拿 DMG · **双击安装即可打开**（已 Apple 公证）· 选服务商粘 API Key 就能用，**不依赖任何命令行工具**

<sub>💡 推荐下载上方官方签名 DMG（免编译、双击即用、权限稳定）· 🤖 AI 助手安装请参考 [AGENTS.md](AGENTS.md)</sub>

<sub>🪟 Windows 为**早期尝鲜版**：核心聊天 / 桌面小怪兽 / 按住说话 / 读写文件跑命令的工具能力都已可用，更多功能正持续对齐中。首次打开若被 Windows 拦一下，点「更多信息 → 仍要运行」即可。</sub>
...
>
> 🪟 **Windows 尝鲜版**：Electron + TypeScript 重做，常驻屏幕顶端的桌面 AI 伴侣。多模型聊天 / 桌面小怪兽 / 按住说话 / 读写文件·跑命令的工具能力均已可用，更多功能正持续对齐 macOS 版。
...
> 🪟 **Windows 尝鲜版**目前由我一个人开发，精力有限、还在持续打磨，难免有不顺手的地方，请多担待 🙏 用着有问题或想法，欢迎加微信一起聊：`fastqingshan`
>
> 💡 想把 HermesPet 用在公司内部、定制成你们品牌的 AI 工具？欢迎邮件聊：[basionwang@gmail.com](mailto:basionwang@gmail.com)
